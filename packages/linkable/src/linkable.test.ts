...
describe('creation of "npm pack" -like symlinks', () => {
  ...
  describe("when called", () => {
    ...
    it("checks for existence of config file", () => {
      expect(existsMock).toHaveBeenCalledWith("/some-directory/some-project/.linkable.json");
    });
    ...
    describe("given config file does not exist", () => {
      ...
      it("creates it as empty", () => {
        expect(writeJsonFileMock).toHaveBeenCalledWith("/some-directory/some-project/.linkable.json", []);
      });
    ...
    describe("given config file exists", () => {
      ...
      it("reads config file", () => {
        expect(readJsonFileMock).toHaveBeenCalledWith("/some-directory/some-project/.linkable.json");
      });
            ...
            describe("when empty link directories are ensured and existence of target files is resolved", () => {
              ...
              it("creates the symlinks to scoped directories", () => {
                expect(createSymlinkMock.mock.calls).toEqual([
                  [
                    {
                      source: "/some-directory/some-project/node_modules/@some-scope/some-module/package.json",
                      target: "/some-directory/some-module/package.json",
                    },
                  ],
                  [
                    {
                      source: "/some-directory/some-project/node_modules/@some-scope/some-module/some-build-directory",
                      target: "/some-directory/some-module/some-build-directory",
                    },
                  ],
                  [
                    {
                      source: "/some-directory/some-project/node_modules/@some-scope/some-other-module/package.json",
                      target: "/some-other-directory/some-other-module/package.json",
                    },
                  ],
                  [
                    {
                      ...
                      target: "/some-other-directory/some-other-module/some-other-build-directory",
                    },
                  ],
                ]);
              });
                    ...
                    [
                      {
                        ...
                        target: "/some-directory/some-module/some-directory-from-glob/some-file-from-glob.txt",
                      },
                    ],

                    [
                      {
                        source: "/some-directory/some-project/node_modules/@some-scope/some-module/some-duplicate-file",
                        target: "/some-directory/some-module/some-duplicate-file",
                      },
                    ],
                    ...
                    [
                      {
                        ...
                        target: "/some-directory/some-module/some-build-directory-with-asterisk",
                      },
                    ],
                    ...
                    [
                      {
                        ...
                        target: "/some-directory/some-module/some-build-directory-with-wild-card",
                      },
                    ],
                    ...
                    [
                      {
                        ...
                        target: "/some-directory/some-module/some-build-directory-with-wild-card-before-asterisk",
                      },
                    ],
              ...
              describe("when existence of files and directories resolve with some non existing", () => {
                ...
                it("creates the symlinks", () => {
                  expect(createSymlinkMock.mock.calls).toEqual([
                    [
                      {
                        source: "/some-directory/some-project/node_modules/some-module/package.json",
                        target: "/some-directory/some-module/package.json",
                      },
                    ],
                    ...
                    [
                      {
                        source: "/some-directory/some-project/node_modules/some-module/some-build-directory",
                        target: "/some-directory/some-module/some-build-directory",
                      },
                    ],
                    ...
                    [
                      {
                        source: "/some-directory/some-project/node_modules/some-module/some-file",
                    ...
                    [
                      {
                        source: "/some-directory/some-project/node_modules/some-other-module/package.json",
                        target: "/some-other-directory/some-other-module/package.json",
                      },
                    ],
