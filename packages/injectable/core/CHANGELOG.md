...
- **injectable:** Accept a named type-parameter bag on v2 token types and creators ([e1df835](https://github.com/ogre-works/ogre-tools/commit/e1df8353e58c7b800f318b24f41db635c28a37d4))
- **injectable:** Give zero-or-one its own maybeFactory and maybeMetaFactory slots ([5143235](https://github.com/ogre-works/ogre-tools/commit/51432359305c9d1bdbc32aabac4dc12cbfbf1545))
- **injectable:** Retire the positional type parameters on v2 token types and creators ([a384d8c](https://github.com/ogre-works/ogre-tools/commit/a384d8c6c16b473c2e952e3f6579ae8c2e9e64f5))
...
- **injectable:** Gate withMeta consumption types, rename Scoped* to Consumption* ([32d6c9b](https://github.com/ogre-works/ogre-tools/commit/32d6c9befd67008101c015abb5acf885a6899ed6))
- **injectable:** Keep ToWithMetaManyFactory's published base-factory semantics ([68d353a](https://github.com/ogre-works/ogre-tools/commit/68d353a8425b48afae85d058c3165ddf14d1f0f6))
- InjectMany(WithMeta?) should be correctly typed for v2 MF tokens ([e9847b5](https://github.com/ogre-works/ogre-tools/commit/e9847b5822f1fb7958f861958c03de50e8776326))
...
- **injectable:** Let getInjectable2 implementation be narrower than its token ([4c6163a](https://github.com/ogre-works/ogre-tools/commit/4c6163af157c8d6f0f85317486e1d6eb43213ba2))
